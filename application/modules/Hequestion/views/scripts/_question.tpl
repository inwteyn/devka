          ...
          <?php if ($option->vote_count):?>
            <div class="hqVoteUsers">
              <ul>
                ...
                ?>
                  <li>
                    <a href="javascript:void(0);" class="hqLinkVoters wall_tips" rev="<?php echo $option->option_id;?>" title="<?php echo $this->translate(array('%s other people', '%s other peoples', $more_count), $more_count);?>">...</a>
                  </li>
                <?php endif;?>
