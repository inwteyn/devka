...
class Pageevent_Form_FormComposer extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this
        ...
        ->setAttrib('action', 'return Pageevent.formSubmit(this);')
    ...
    $this->addElement('Datepicker', 'start', array(
      'allowEmpty' => false,
      'required' => true,
    ));
    $this->start->setLabel('PAGEEVENT_FORM_STARTTIME');

    $this->addElement('Datepicker', 'end', array(
      'allowEmpty' => false,
      'required' => true,
    ));
    $this->end->setLabel('PAGEEVENT_FORM_ENDTIME');
    ...
    $this->addElement('Button', 'submit', array(
      'label' => 'Save Changes',
      'type' => 'button',
      'onclick' => 'Pageevent.formSubmit(this);',
      'ignore' => true,
      'decorators' => array(
        'ViewHelper',
      ),));
