...
class Pageevent_View_Helper_Datepicker extends Zend_View_Helper_FormElement
{
  ...
  public function datepicker($name, $value = null, $attibs = null)
  {
    ...
    $this->view->headScript()
        ->appendFile( $this->view->baseUrl() . '/application/modules/Pageevent/externals/scripts/datepicker.js')
        ->appendScript($js_str);
