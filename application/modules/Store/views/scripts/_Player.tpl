...
// this forces every playlist to have a unique ID, so that a playlist can be displayed twice on the same store
$random = '';
for ($i = 0; $i < 6; $i++) {
  $d = rand(1, 30) % 2;
...
<!--          <div class="storemusic-item-share">
...
<?php else : ?>
  <br/>
  <div class="tip"><span><?php echo $this->translate('storemusic_NO_SONGS_TEXT'); ?></span></div>
<?php endif; ?>
