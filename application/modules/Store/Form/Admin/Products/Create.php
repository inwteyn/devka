...
//    $this->addElement('FancyUpload', 'file');
    ...
    $category1 = $this->getSubForm('fields')->getElement('0_0_1');
    $multiOptions1 = $category1->getMultiOptions();
    foreach ($multiOptions1 as $key => $value) {
      if ($key == '') unset($multiOptions1[$key]);
    }
    $category1->setMultiOptions($multiOptions1);
    $category1->setValue(1);
    // Element: params
