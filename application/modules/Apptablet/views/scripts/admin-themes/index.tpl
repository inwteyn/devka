...
<div class="apptablet_admin_theme_buttons">
  <a class="button" href="<?php echo $this->url(array('module'=>'apptouch','controller'=>'themes','action'=>'index'), 'admin_default')?>"><?php echo $this->translate('Touch Theme Editor');?></a>
  <a class="button active" href="<?php echo $this->url(array('module'=>'apptablet','controller'=>'themes','action'=>'index'), 'admin_default')?>"><?php echo $this->translate('Tablet Theme Editor');?></a>
</div>
