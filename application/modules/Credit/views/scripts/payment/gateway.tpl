...
<?php else: ?>
  ...
  <form method="post"
        action="<?php echo $this->escape($this->url(array('action' => 'credit-order'), 'credit_payment', true)) ?>"
        ...
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
            ...
            foreach ($this->gateways as $gatewayInfo):
              ...
              ?>
              <?php if ($gateway->gateway_id == 1 || $gateway->title == "2Checkout") {
              continue;
            } ?>
