      ...
      <tbody>
        <?php foreach( $this->actionTypes as $key => $type ): ?>
          ...
          <tr>
            ...
            <td><input type="text" value="<?php echo $type->credit ?>" name="credit-<?php echo $type->action_id?>" size="7" /></td>
            <td><input type="text" value="<?php echo $type->max_credit ?>" name="max_credit-<?php echo $type->action_id?>" size="7" /></td>
            <td><input type="text" value="<?php echo $type->rollover_period ?>" name="rollover_period-<?php echo $type->action_id?>" size="7" />
