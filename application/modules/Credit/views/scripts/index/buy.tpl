...
<form method="post" action="<?php echo $this->url(array('action' => 'gateway', 'format'=>'smoothbox'), 'credit_payment', true)?>" id="choose_price_form" class="" enctype="application/x-www-form-urlencoded">
  <div>
    <div>
