  ...
  <table class='admin_table'>
    <thead>
      <tr>
        ...
        <?php $class = ( $this->order == 'offer_id' ? 'admin_table_ordering admin_table_direction_' . strtolower($this->direction) : '' ) ?>
        <th style='width: 1%;' class='admin_table_centered <?php echo $class ?>'>
    ...
    <tbody>
      <?php foreach( $this->paginator as $item ):
        ...
        <tr>
          ...
          <td class='center'>
            <?php echo ($offer) ? $this->htmlLink($offer->getHref(), $offer->getTitle(), array()) : 'Deleted item'; ?>
          </td>
          <td class='center'>
            <?php
              if ($offer && $offer->getPage()) {
                echo $this->htmlLink($offer->getPage()->getHref(), $offer->getPage()->getTitle(), array());
              } elseif ($offer) {
                echo $this->htmlLink($offer->getOwner()->getHref(), $offer->getOwner()->getTitle(), array());
              } else {
                echo '-';
              }
            ?>
