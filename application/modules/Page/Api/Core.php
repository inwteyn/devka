...
class Page_Api_Core extends Core_Api_Abstract
{
    ...
    public function getSimilarCategories($page = null, $fo = null)
    {
        if (!$page || !$fo)
            return array();
...
//    $paginator->setItemCountPerPage(1);
    ...
    public function isWidgetVisible($page = null)
    {
        if (!$page || $page->isTimeline()) {
            return false;
        }
    ...
    public function getWidgetsPseudonyms()
    {
        return array(
            'html' => 'page.html-block',
            'rate' => 'rate.widget-rate',
            'simular-page' => 'page.similar-pages',
            'photos' => 'page.profile-photo',
            'like' => 'like.status',
            'notes' => 'page.profile-note',
            'favorite-pages' => 'page.favorite-pages',
            'profile-address' => 'page.profile-address',
            'page-team' => 'page.profile-admins',
            'member-like-this' => 'like.box',
            'page-options' => 'page.profile-options',
            'search' => 'page.search',
            'tag-cloud' => 'page.tag-cloud',
            'page-statistics' => 'page.page-statistics',
            'login-signup' => 'user.login-or-signup',
            'favorite-offer' => 'offers.favorite-offer',
            'invite' => 'suggest.invite-friends-page',
            'updates' => 'wall.feed',
            'album' => 'pagealbum.profile-album',
            'video' => 'pagevideo.profile-video',
            'event' => 'pageevent.profile-event',
            'music' => 'pagemusic.profile-music',
            'contact' => 'pagecontact.profile-contact',
            'checkins' => 'checkin.page-checkins',
            'blog' => 'pageblog.profile-blog',
            'badges' => 'hebadge.page-badges',
            'faq' => 'pagefaq.profile-faq',
            'info' => 'page.profile-fields',
            'discussion' => 'pagediscussion.profile-discussion',
            'document' => 'pagedocument.profile-document',
            'donation' => 'donation.page-profile-donations',
            'links' => 'page.page-links',
            'store' => 'store.page-profile-products',
            'staff' => 'page.profile-staff',
            'review' => 'rate.page-review',
