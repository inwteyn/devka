      ...
      <div  class="item <?php echo (Engine_Api::_()->like()->isLike($page)) ? 'liked_item' : '' ?>" >
          <div onmouseover="listShowLike('<?php echo $page->getIdentity()?>')" onmouseout="listHideLike('<?php echo $page->getIdentity()?>')" style="position:relative">
              ...
              <span style="display:<?php echo (Engine_Api::_()->like()->isLike($page)) ? 'none' : 'block' ?>;">
                <a href="javascript:void(0)" class="like_button_link list_like" onfocus="this.blur();" id="featLike_<?php echo $page->getGuid(); ?>"><i class="hei hei-thumbs-o-up"></i><span class="like_button"><?php echo  $this->translate('like_Like'); ?></span></a>
              </span>
              <span style="display:<?php echo (Engine_Api::_()->like()->isLike($page)) ? 'block' : 'none' ?>;">
                <a href="javascript:void(0)" class="like_button_link list_unlike" onfocus="this.blur();" id="featUnlike_<?php echo $page->getGuid(); ?>"><i class="hei hei-thumbs-o-down"></i><span class="unlike_button"><?php echo  $this->translate('like_Unlike'); ?></span></a>
              </span>
