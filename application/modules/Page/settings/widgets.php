...
$page = array(
    ...
    array(
        'title' => 'Similar Pages',
        'description' => 'Displays Similar Pages',
        'category' => 'Widgets',
        'type' => 'widget',
        'name' => 'page.similar-pages',
        'defaultParams' => array(
            'title' => 'Similar Pages',
        )
    ),
    ...
    array(
        'title' => 'Page Details Map',
        'description' => 'Displays Map',
        'category' => 'Widgets',
        'type' => 'widget',
        'name' => 'page.profile-address',
        'defaultParams' => array(
            'title' => ' ',
        )
    ),
    ...
    array(
        'title' => 'Likes',
        'description' => 'Displays a users who liked this page',
        'category' => 'Tabs',
        'type' => 'widget',
        'name' => 'page.page-likes',
        'requirements' => array(
            'no-subject',
        ),
        'defaultParams' => array(
...
if ($modulesTbl->isModuleEnabled('suggest')) {
    $others[] = array(
        'title'=> 'Invite Friends Page',
        'description'=>'Displays list of friends who haven\'t liked page yet',
        'category'=>'Widgets',
        'type'=>'widget',
        'name'=>'suggest.invite-friends-page',
        'defaultParams'=>array(
