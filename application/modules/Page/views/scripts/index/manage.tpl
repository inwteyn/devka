        ...
        <div class="page_list_item_info">
          ...
          <div class="page_options">
            <?php echo $this->htmlLink($this->url(array(
                ...
                '<i class="hei hei-pencil-square-o"></i><span>'. $this->translate("Edit") .'</span>',
                array("class" => "manage_page_edit manage_page_buttons")); ?>
            <?php echo $this->htmlLink($this->url(array(
                'action' => 'delete',
                'page_id' => $page->getIdentity()), 'page_team'),
                '<i class="hei hei-trash-o"></i><span>'. $this->translate("Delete") .'</span>',
                array("class" => "manage_page_delete manage_page_buttons")); ?>
          </div>
        </div>
