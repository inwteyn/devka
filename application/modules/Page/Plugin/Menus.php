...
// Timeline Page
  ...
  public function onMenuInitialize_PageProfileStore($row)
  {
    ...
    $subject = Engine_Api::_()->core()->getSubject();
    $viewer = Engine_Api::_()->user()->getViewer();
    $isApp = Engine_Api::_()->hasModuleBootstrap('appmanager') && Engine_Api::_()->apptouch()->isApp();
    if (!$isApp && $viewer->getIdentity() && $subject->isStore() && $subject->getStorePrivacy() && $subject->isAllowStore()) {
      return array(
