...
class Page_Form_ClaimPage extends Engine_Form
{
  public function init()
  {
    ...
    $this->addElement('Checkbox', 'terms', array(
      ...
      'description' => sprintf(Zend_Registry::get('Zend_Translate')->_("Join form <a href='javascript:void(0);' onclick=window.open('%s','mywindow','width=500,height=300')>terms</a>."), $url),
      'allowEmpty' => false,
      'required' => true,
      'validators' => array(
        'notEmpty'
