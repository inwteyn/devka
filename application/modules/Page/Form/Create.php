...
class Page_Form_Create extends Engine_Form
{
  ...
  public function init()
  {
    ...
    if($short_url == 0){
      ...
      $host_url = str_ireplace('http://','',str_ireplace('browse-pages','',$_SERVER['HTTP_HOST'].Zend_Controller_Front::getInstance()->getRouter()->assemble(array('page_id' => 'pagename'), 'page_view')));
    }
