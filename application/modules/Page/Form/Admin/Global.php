  ...
  public function init()
  {
    ...
    */
    ...
    $this->addElement('Radio', 'show_owner', array(
      ...
      $host_url = str_ireplace('page/','',$_SERVER['HTTP_HOST'].Zend_Controller_Front::getInstance()->getRouter()->assemble(array('page_id' => 'pagename'), 'page_view'));
      $host_url_2 = $_SERVER['HTTP_HOST'].Zend_Controller_Front::getInstance()->getRouter()->assemble(array('page_id' => 'pagename'), 'page_view');


$description = <<<description
Do you want to enable URL-shortener for pages - <a href="$host_url">$host_url</a>? If you have any type of URL-shortener (for members, listings, etc) on your site then it may cause conflicts and errors.
description;
    $this->addElement('Dummy', 'cover-photo', array(
      'label' => 'Allow short URL?',
      'content' => $description
    ));
    $this->addElement('Radio', 'short_url', array(
      ...
      'description' => '',
      'multiOptions' => array(
        '0' => 'No, disable. Page URL:'.$host_url_2,
        '1' => 'Yes, enable. Page URL: '.$host_url,
      ),
      'value' => $settings->getSetting('page.short.url','0'),
    ));
