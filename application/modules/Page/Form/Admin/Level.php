...
$multiOptions = array();
    ...
    $this->addElement('MultiCheckbox', 'auth_features', array(
      ...
      'value' => array('pagealbum', 'pageblog','pagediscussion', 'pagedocument', 'pageevent', 'pagemusic', 'pagevideo', 'rate', 'pagecontact', 'store', 'pagefaq', 'donation', 'offers','pageinstagram')
    ));
