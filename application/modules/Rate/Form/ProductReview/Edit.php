...
class Rate_Form_ProductReview_Edit extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $this
      ...
      ->setAttrib('onsubmit', 'return ProductReview.editSubmit(this);');
    ...
    $this->addElement('Hidden', 'productreview_id', array('order' => 993));
