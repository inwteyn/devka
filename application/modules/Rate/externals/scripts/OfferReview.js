      ...
      self.request(self.url.create, $(this).toQueryString(),
        function (obj) {
          ...
          if (obj.result) {
            ...
            $form.getElements('.review_stars .rate_style').removeClass('rated');
            self.setCount(1);
            setTimeout(function () {
              self.view(obj.id);
            }, self.timeOut);
    ...
    if (self.$container) {
      ...
      self.$stars.addEvent('click', function () {
        ...
        if ($star) {
          ...
          var $prev = $star.getAllPrevious();
          var $next = $star.getAllNext();

          $prev.removeClass('hei-star-o').addClass('hei-star');
          $star.removeClass('hei-star-o').addClass('hei-star');
          $next.removeClass('hei-star').addClass('hei-star-o');
        }
      });
    }
