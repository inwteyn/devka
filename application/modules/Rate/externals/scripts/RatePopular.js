...
function RatePopular(id, type, uid, options)
{
    console.log("Heey ");
    this.id = id;
    this.type = type;
    ...
    this.$stars_cont = $( this.uid);
    this.construct();
}

RatePopular.prototype =
{
    construct: function()
    {
        var self = this;
        ...
        this.$stars = this.$stars_cont.getElements('.rate_style');
        this.$stars.addEvent('mouseover', function()
        {
            ...
            .addEvent('click', function()
            {
                ...
                $star = $(this);
                var score = $star.getProperty('id').substr(12);
                console.log($star.getProperty('id'));
                self.rate(score);
            });
    ...
    {
        this.$stars.removeClass('hei-star-o')
            .removeClass('hei-star-half-o');
