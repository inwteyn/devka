 ...
 * @license    http://www.socialengine.net/license/
 */
class Touch_Widget_AdminStatisticsController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->touchVersion = Engine_Api::_()->getDbtable('modules', 'core')->select()
    ...
    $statistics['core.views'] = array(
      'label' => 'Page Views',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.core.views'),
    ...
    $statistics['user.creations'] = array(
      'label' => 'Members',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.user.creations'),
    ...
    $statistics['user.logins'] = array(
      'label' => 'Sign-ins',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.user.logins'),
    ...
    $statistics['messages.creations'] = array(
      ...
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.messages.creations'),
    ...
    $statistics['user.friendships'] = array(
      'label' => 'Friendships',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.user.friendships'),
    ...
    $statistics['core.comments'] = array(
      'label' => 'Comments',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.core.comments'),
    ...
    $statistics['core.likes'] = array(
      'label' => 'Likes',
      'touch' => Engine_Api::_()->getDbtable('statistics', 'core')->getTotal('touch.core.likes'),
...
//      );
    ...
    $columns = array(
      ...
      array('number', $this->view->translate("TOUCH_Via Touch Mobile")),
      array('number', $this->view->translate("TOUCH_On Standard Site"))
    );
    $rows = array();
    $options = array(
    ...
    foreach($statistics as $key=>$stat){
      $touch = (float)$stat['touch'];
      $std = (float)($stat['total'] - $touch);
      if($touch==0 && $std == 0)
        continue;
...
//      }
//
      $rows[$i] = array($this->view->translate($stat['label']).' ('.$touch.'/'.$std.')', $touch>1000 ? $touch/1000: $touch, $std>1000 ? $std/1000: $std);
      $i++;
    }
    $chart_params = array(
      'type' => 'column',
