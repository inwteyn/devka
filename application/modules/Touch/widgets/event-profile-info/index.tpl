  ...
  <ul class="touch_event_stats">
   ...
   <?php endif;?>
    <li>
      ...
      <div class="event_stats_content"><?php echo $this->htmlLink($this->subject()->getParent()->getHref(), $this->subject()->getParent()->getTitle(), array('class' => 'touchajax'));?></div>
    </li>
    <?php endif;?>
