    ...
    <div class="wallComposer wall-social-composer tli l">
      ...
      <form method="post" action="<?php echo $this->url()?>">
        ...
        <div class="submitMenu touch_tab_group">
          ...
          <?php if ($this->allowPrivacy):?>
            ...
            <div class="wall-privacy-container">
              <a href="javascript:void(0);" class="wall-privacy-link wall_tips wall_blurlink touch_tab touch_tab_dark" title="<?php echo $this->translate('WALL_PRIVACY_' . strtoupper($this->privacy_type) . '_'  . strtoupper($this->privacy_active));?>">
        ...
        $params = array(
          ...
          'subject_uid' => $this->subject()?$this->subject()->getIdentity():null
        );
