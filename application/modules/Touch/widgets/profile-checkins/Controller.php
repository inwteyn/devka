...
class Touch_Widget_ProfileCheckinsController extends Engine_Content_Widget_Abstract
{
  protected $_childCount = 0;
  public function indexAction()
  {
    if(!Engine_Api::_()->touch()->isModuleEnabled('checkin'))
    ...
    if($this->view->activityCount > 0 ) {
      $this->_childCount = $this->view->activityCount;
    }
