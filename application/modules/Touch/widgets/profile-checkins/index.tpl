...
<?php
  $this->headScript()
     //->appendFile('http://maps.googleapis.com/maps/api/js?sensor=true')
     ->appendFile($this->baseUrl() . '/application/modules/Touch/modules/Checkin/externals/scripts/core.js');
 ?>

<?php if (!$this->last_id) : ?>
  <?php if ($this->markers && count($this->activity) > 0) : ?>
    <div class="checkin_view_mode touch_tab_group" style="overflow: hidden;">
      <div class="touch_tab">
        <h3 class="checkin_title"><?php echo $this->translate('CHECKIN_VIEW_MODE_DESC')?></h3>
      </div>
      <div class="touch_tab_right touch_tab_dark">
        <a class="map checkin-view-types" title="<?php echo $this->translate('CHECKIN_map view'); ?>" onfocus="this.blur();" href="javascript://" onclick="$checkin_map.setView('map', $(this));"></a>
      </div>
      <div class="touch_tab_right touch_tab_dark">
        <a class="list active checkin-view-types" title="<?php echo $this->translate('CHECKIN_list view'); ?>" onfocus="this.blur();" href="javascript://" onclick="$checkin_map.setView('list', $(this));"></a>
      </div>
    </div>
    ...
    <script type="text/javascript">
      ...
      en4.core.runonce.add(function() {
        $checkin_map = new CheckinMap( null, <?php echo $this->markers; ?>, 4, <?php echo $this->bounds; ?>, 'map_canvas');
      });
    </script>

    <div style="position: relative;">
      <div id="" style="overflow: hidden;">
        <div id="map_canvas" class="browse_gmap" style="position: absolute; top: 100000px"></div>
      </div>
    </div>
  <?php endif; ?>
...
<?php echo $this->render('_twheader.tpl'); ?>
...
<script type="text/javascript">
  Wall.runonce.add(function (){
    var feed = new Wall.Feed({
      ...
      enableComposer: 0,
      url_wall: '<?php echo $this->url(array('module' => 'core', 'controller' => 'widget', 'action' => 'index', 'name' => 'touch.profile-checkins'), 'default', true) ?>',
