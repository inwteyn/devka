...
class Touch_Widget_MenuFooterController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $defaultLanguage = Engine_Api::_()->getApi('settings', 'core')->__get('core.locale.locale', 'en');
