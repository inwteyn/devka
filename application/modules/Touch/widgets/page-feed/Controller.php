...
class Touch_Widget_PageFeedController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if (!Engine_Api::_()->touch()->checkPageWidget($subject_id, 'touch.page-feed')){
    ...
    $loader = new Zend_Loader_PluginLoader(array(
      'Touch_Model_Helper_' => $path . '/Model/Helper'
    ));
