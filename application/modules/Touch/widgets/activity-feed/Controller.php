...
class Touch_Widget_ActivityFeedController extends Engine_Content_Widget_Abstract
{
public function indexAction()
  {
    ...
    if( Engine_Api::_()->core()->hasSubject() ) {
      ...
      if( !$subject->authorization()->isAllowed($viewer, 'view') || $this->_getParam('from_tl',isset($_GET['from_tl'])?$_GET['from_tl']:false)) {
