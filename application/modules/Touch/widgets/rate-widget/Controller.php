...
class Touch_Widget_RateWidgetController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if ($subject->getType() == 'page'){
      if (!Engine_Api::_()->touch()->checkPageWidget($subject->getIdentity(), 'touch.blog.rate-widget')){
        return $this->setNoRender();
      }
    }
