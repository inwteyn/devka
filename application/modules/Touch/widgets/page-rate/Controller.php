...
class Rate_Widget_PageRateController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    if (!Engine_Api::_()->touch()->isModuleEnabled('page')){
    ...
    $mostRates = $tbl->fetchMostRated($maxItems, $minVotes);
    ...
    if ($period) {
      $this->view->month_rates = $this->_prepareRates($tbl->fetchMostRated($maxItems, $minVotes, 'month'));
      $this->view->week_rates = $this->_prepareRates($tbl->fetchMostRated($maxItems, $minVotes, 'week'));
    }
