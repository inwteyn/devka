...
class Video_IndexController extends Touch_Controller_Action_Standard
{
  ...
  public function rateAction()
  {
    ...
    try
    {
      ...
      $video->rating = $total = Engine_Api::_()->video()->getRating($video->getIdentity());
      $video->save();
  ...
  public function createAction()
  {
    ...
    // Create form
    $this->view->form = $form = new Touch_Form_Video_Video();
    ...
    $redirect_url = ($video->type == 3)
        ? $this->view->url(array('action' => 'manage'), 'video_general', true)
        : $this->view->url(array('user_id' => $viewer->getIdentity(), 'video_id' => $video->getIdentity()), 'video_view', true);

    $this->_forward('success', 'utility', 'touch', array(
      'messages' => array(Zend_Registry::get('Zend_Translate')->_('TOUCH_VIDEO_FORM_CREATE_SUCCESS')),
  ...
  public function uploadVideo($file, $params)
  {
    ...
    try
    {
      ...
      $video = Engine_Api::_()->video()->createVideo($params, $file, $values);
  ...
  public function editAction()
  {
    ...
    $this->view->form = $form = new Touch_Form_Video_Edit();
    ...
    $this->_forward('success', 'utility', 'touch', array(
      'messages' => array(Zend_Registry::get('Zend_Translate')->_('TOUCH_VIDEO_FORM_EDIT_SUCCESS')),
      'parentRedirect' => $this->view->url(array('action' => 'manage'), 'video_general', true),
    ));
  ...
  public function viewAction()
  {
    ...
    if ($video->status==1){
      ...
      $embedded = $this->view->touchRichContent($video, array(true));
    }
