...
class Event_MemberController extends Touch_Controller_Action_Standard
{
  ...
  public function joinAction()
  {
    ...
    if( $subject->membership()->isResourceApprovalRequired() ) {
      ...
      if (empty($row)) {
        ...
        return $this->_helper->touchRedirector->gotoRoute(array('action' => 'request', 'format' => 'smoothbox'));
      } elseif ($row['user_approved'] && !$row['resource_approved']) {
        // has requested an invite; show cancel invite page
        return $this->_helper->touchRedirector->gotoRoute(array('action' => 'cancel', 'format' => 'smoothbox'));
      }
    }
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Event joined');
  ...
  public function requestAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Your invite request has been sent.');
  ...
  public function cancelAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) ) {
      ...
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Your invite request has been cancelled.');
  ...
  public function leaveAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Event left');
  ...
  public function rejectAction()
  {
    ...
    $this->view->status = true;
    $this->view->message = Zend_Registry::get('Zend_Translate')->_('Event invite rejected');
  ...
  public function removeAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Event member removed.');
  ...
  public function approveAction()
  {
    ...
    if( $this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost()) )
    {
      ...
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')->_('Event request approved');
