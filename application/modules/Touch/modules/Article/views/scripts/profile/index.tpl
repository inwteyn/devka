 ...
 * @version    $Id: index.tpl 2011-07-22 11:18:13 ulan $
 * @author     Ulan
 */
...
<ul class="items subcontent">
  ...
  <li style="text-align: right;">
    <?php  ?>
    <?php if ($this->canEdit):?>
    <a href='<?php echo $this->url(array('action'=>'edit', 'article_id' => $this->article->article_id), 'article_specific', true) ?>' class='touchajax'><img src='application/modules/Touch/externals/images/edit.png'/></a>
    <?php endif; ?>

    <?php if ($this->canDelete):?>
    <a href='<?php echo $this->url(array('action'=>'delete', 'article_id' => $this->article->article_id), 'article_specific', true) ?>' class='smoothbox'><img src='application/modules/Touch/externals/images/delete.png' /></a>
    <?php endif; ?>
  </li>
  ...
  <div class="article_entrylist_entry_photos">
    ...
    <ul class="items">
      <?php foreach( $this->paginator as $photo ): $hasphoto = true?>
