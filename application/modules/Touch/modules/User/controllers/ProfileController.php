...
class User_ProfileController extends Touch_Controller_Action_Standard
{
   	...
   	if ( $this->_getParam('format') == 'json')
		{
			...
			$this->view->html = $content->render('user_profile_index');
			$this->view->status = 1;
			$this->view->hash = str_replace('&format=json', '', $_SERVER['REQUEST_URI']);
