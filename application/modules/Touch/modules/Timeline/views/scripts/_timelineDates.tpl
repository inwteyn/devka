  ...
  en4.core.runonce.add(function () {
    if (typeof(timeline) == 'object') {
      ...
      timeline.options.life_event_url = <?php echo Zend_Json::encode($this->url(
        array('id' => $this->subject()->getIdentity()), 'timeline_life_event', true)); ?>;
...
<?php if (isset($this->dates['last_month'])): ?>
  <li rev="<?php echo $this->dates['last_month']['year'] . '-' . $this->dates['last_month']['month']; ?>">
    <span class="month">
      <a href="javascript://"><?php echo $this->translate($this->dates['last_month']['title']); ?></a>
    </span>
  </li>
  <?php endif; ?>
    ...
    <ul class="months">
      ...
      <li rev="<?php echo $month['year'] . '-' . $month['month']; ?>"
          ...
          <span class="month" rev="<?php echo $month['max_id'] . ' ' . $month['min_id'] ?>">
            <a href="javascript://"><?php echo $this->translate($month['title']); ?></a>
          </span>
      </li>
      <?php endforeach; ?>
    </ul>
...
<?php if (array_key_exists('born', $this->dates)): ?>
    <li rev="born">
      <span class="life-event"
            ...
            title="<?php echo $this->translate('Born'); ?>">
        <a href="javascript://"><?php echo $this->translate('Born'); ?></a>
      </span>
    </li>
  <?php endif; ?>
