...
<div class="touch-navigation">
		...
		<div class="navigation-body">
          ...
          <?php $params = array(
            ...
            'subject' => $this->group->getGuid()
				...
				<div class="item">
					<?php echo $this->htmlLink($this->group->getHref(), $this->translate('TOUCH_BACK_TO_ITEM', $this->group->getTitle()), array("class" => "touchajax")) ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="navigation_content">
		<div class="layout_content">
			...
			<?php if( $this->canEdit ): ?>
        &nbsp;<?php echo $this->htmlLink(array('route' => 'group_extended', 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->photo->getIdentity()), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
			...
			<?php echo $this->touchAction("list", "comment", "core", array("type"=>"group_photo", "id"=>$this->photo->getIdentity(), 'viewAllLikes'=>true)); ?>
