...
echo $this->render('_twheader.tpl')
?>
...
<div class="wall-view-action-title">
  <div class="item_photo">
    ...
    <a href="<?php echo $this->action->getObject()->getTitle();?>" class="feed_item_username wall_liketips" rev="<?php echo $this->action->getObject()->getGuid();?>"><?php echo $this->itemPhoto($this->action->getObject(), 'thumb.icon');?></a>
    <?php else :?>
    <a href="<?php echo $this->action->getSubject()->getTitle();?>" class="feed_item_username wall_liketips" rev="<?php echo $this->action->getSubject()->getGuid();?>"><?php echo $this->itemPhoto($this->action->getSubject(), 'thumb.icon');?></a>
    <?php endif;?>
  </div>
  <div class="item_title">
    <?php if (Engine_Api::_()->wall()->isOwnerTeamMember($this->action->getObject(), $this->action->getSubject())): ?>
    <a href="<?php echo $this->action->getObject()->getTitle();?>" class="feed_item_username wall_liketips" rev="<?php echo $this->action->getObject()->getGuid();?>"><?php echo $this->action->getObject()->getTitle();?></a>
    <?php else: ?>
    <a href="<?php echo $this->action->getSubject()->getTitle();?>" class="feed_item_username wall_liketips" rev="<?php echo $this->action->getSubject()->getGuid();?>"><?php echo $this->action->getSubject()->getTitle();?></a>
    <?php endif;?>
    <div>
      <ul>
...
<div class="wallFeed" id="<?php echo $this->feed_uid?>">
  ...
  <ul class="wall-feed feed" id="activity-feed">
    <li rev="item-<?php echo $this->action->action_id ?>" class="wall-action-item <?php if ($this->comment_pagination):?>action_comment_pagination<?php endif;?>" >
      <?php echo $this->wallActivity($this->action, array('noList' => true, 'comment_pagination' => $this->comment_pagination, 'comment_page' => $this->comment_page)); ?>
    </li>
  </ul>
