...
<?php if( $this->action->getTypeInfo()->commentable ): // Comments - likes ?>
  ...
  <?php
    ...
    if ($this->comment_pagination){
      ...
      $select = $this->action->comments()->getCommentSelect();
...
?>
        ...
        <li class="container-comment_likes">
          ...
          <div class="comments_likes">
            ...
            <?php else: ?>
              <?php echo $this->htmlLink($this->action->getSubject()->getHref(array('action_id' => $this->action->action_id, 'show_likes' => true)),
            ...
            <li>
              ...
              <div class="comments_viewall">
                <?php if( $this->action->comments()->getCommentCount() > 2): ?>
                  ...
                  <?php echo $this->htmlLink($this->url(array('action' => 'view', 'action_id' => $this->action->action_id, 'comment_pagination' => true), 'wall_extended'),
             ...
             <div class="comments_info">
               ...
               <div class="comments_date">
                 <?php echo $this->timestamp($comment->creation_date); ?>
                  ...
                  <?php if ( $this->viewer()->getIdentity() && (('user' == $this->action->subject_type && $this->viewer()->getIdentity() == $this->action->subject_id) || ($this->viewer()->getIdentity() == $comment->poster_id) ) ): ?>
