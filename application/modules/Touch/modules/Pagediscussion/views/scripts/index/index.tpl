...
<?php if (count($this->paginator)):?>
  ...
  <?php if ($this->canCreate): ?>
    <div class="touch_box" style="padding-bottom:0;">
      <a href="<?php echo $this->url(array('action' => 'create', 'page_id' => $this->subject->getIdentity()), 'page_discussion', true)?>" class="touchajax"><?php echo $this->translate('PAGEDISCUSSION_CREATE')?></a>
    </div>
  <?php endif;?>

  <ul class="items touch_box">
