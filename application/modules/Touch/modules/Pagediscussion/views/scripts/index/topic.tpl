...
<div class="touch_box">
    ...
    <?php if ($this->canPost && !$this->topic->closed):?>
        <a href="<?php echo $this->url(array('action' => 'post', 'topic_id' => $this->topic_id))?>" class="smoothbox">
    ...
    <?php if ($this->isWatching):?>
        <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'watch', 'set' => 0,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
           class="touchajax">
            <?php echo $this->translate('PAGEDISCUSSION_OPTIONS_UNWATCHING')?>
        </a>
    <?php else: ?>
        <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'watch', 'set' => 1,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
           class="touchajax">
    ...
    <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'sticky', 'set' => 0,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="touchajax">
        <?php echo $this->translate('PAGEDISCUSSION_OPTIONS_UNSTICKY')?>
    </a>
    <?php else: ?>
    <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'sticky', 'set' => 1,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="sticky">
    ...
    <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'close', 'set' => 0,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="unclose">
        <?php echo $this->translate('PAGEDISCUSSION_OPTIONS_UNCLOSE')?>
    </a>
    <?php else: ?>
    <a href="<?php echo $this->url(array('action' => 'discussion', 'task' => 'close', 'set' => 1,  'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="close">
    ...
    <a href="<?php echo $this->url(array('action' => 'rename', 'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="touchajax">
    ...
    <a href="<?php echo $this->url(array('action' => 'delete-topic', 'topic_id' => $this->topic_id), 'page_discussion', true)?>"
       class="smoothbox">
    ...
    <div class="pagediscussion_topic_closed result_message"><?php echo $this->translate('PAGEDISCUSSION_CLOSED');?>
    </div>
    <?php endif;?>
    ...
    <li class="pagediscussion_topic">
        ...
        <div class="item_body">
            ...
            <div class="item_options">
                <?php if ($this->canPost && !$this->topic->closed):?>
                <a href="<?php echo $this->url(array('action' => 'post', 'post_id' => $post->getIdentity(), 'topic_id' => $this->topic_id), 'page_discussion', true)?>"
                   class="touchajax">
                    <?php echo $this->translate('PAGEDISCUSSION_POST_QUOTE')?>
                </a>
                <?php endif;?>
                <?php if ($this->hasViewer && ($owner->isSelf($this->viewer) || $this->isTeamMember)):?>
                <a href="<?php echo $this->url(array('action' => 'edit', 'post_id' => $post->getIdentity()), 'page_discussion', true)?>"
                   class="touchajax">
                    <?php echo $this->translate('PAGEDISCUSSION_POST_EDIT')?>
                </a>
                <a href="<?php echo $this->url(array('action' => 'delete-post', 'post_id' => $post->getIdentity()), 'page_discussion', true)?>"
                   class="smoothbox">
