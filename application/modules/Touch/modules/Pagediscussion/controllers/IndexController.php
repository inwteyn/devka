...
class Pagediscussion_IndexController extends Touch_Controller_Action_Standard
{
    protected $_subject;
    ...
    {
        $isPageEnabled = Engine_Api::_()->touch()->isModuleEnabled('page');
    ...
    public function topicAction()
    {
        ...
        {
            return $this->_forward('error', 'core-utility', 'touch', array(
...
//        }
        if ($result) {
            $this->_redirectCustom(array('route' => 'page_discussion', 'action' => 'topic', 'topic_id' => $this->view->topic_id));
        }
    ...
    public function postAction()
    {
        ...
        //        }
        if ($result) {
            $this->_redirectCustom(array('route' => 'page_discussion', 'action' => 'topic', 'post_id' => $this->view->post_id));
        }
    }
...
//        }
        ...
        if ($result) {
            $this->_redirectCustom(array('route' => 'page_discussion', 'action' => 'topic', 'topic_id' => $topic_id));
        }else{
            $this->_redirectCustom(array('route' => 'page_discussion', 'action' => 'index', 'page_id' => $page_id));
        }
