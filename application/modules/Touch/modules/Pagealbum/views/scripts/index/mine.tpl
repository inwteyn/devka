        ...
        <li>
          ...
          <div class="item_body">
            ...
            <div class="item_options">
              <a href="<?php echo $this->url(array('action' => 'delete', 'page_id' => $this->subject()->getIdentity(),
                'album' => $album->getIdentity()), 'page_album', true)?>" class="smoothbox">
                <?php echo $this->translate("Delete"); ?>
              </a>

              -
              <a href="<?php echo $this->url(array('action' => 'edit', 'page_id' => $this->subject()->getIdentity(),
                'pagealbum_id' => $album->getIdentity()), 'pagealbum_specific', true); ?>" onclick = 'Touch.navigation.subNavRequest($(this)); return false;'>
