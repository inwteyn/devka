...
<h4>
  ...
  &raquo; <?php echo $this->htmlLink(array('route' => 'page_event', 'action' => 'index', 'page_id' => $this->subject->getIdentity()), $this->translate('TOUCH_PAGE_EVENTS')) ?>
  ...
  &raquo; <?php echo $this->translate('TOUCH_PAGE_EVENT_MEMBERS_WAITING');?>
</h4>
...
<?php else:?>
    ...
    <div><?php echo $this->translate('TOUCH_NO_ITEMS')?></div>
