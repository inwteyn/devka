...
<div class="touch-navigation">
		...
		<div class="navigation-body">
          ...
          <?php $params = array(
            ...
            'subject' => $this->classified->getGuid()
				...
				<div class="item">
					<?php echo $this->htmlLink($this->classified->getHref(), $this->translate('TOUCH_BACK_TO_ITEM', $this->classified->getTitle()), array("class" => "touchajax")) ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="navigation_content">
		<div class="layout_content">
			...
			<?php if( $this->canEdit ): ?>
        &nbsp;<?php echo $this->htmlLink(array('route' => 'classified_extended', 'controller' => 'photo', 'action' => 'edit', 'photo_id' => $this->photo->getIdentity()), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
