 ...
 * @version    $Id: SubscriptionController.php 2011-04-26 11:18:13 mirlan $
 * @author     Mirlan
 */
...
class Payment_SubscriptionController extends Touch_Controller_Action_Standard
{
  /**
   * @var User_Model_User
   */
  ...
  public function chooseAction()
  {
    ...
    return $this->_helper->touchRedirector->gotoRoute(array('action' => 'gateway'));
  }
  ...
  public function gatewayAction()
  {
    ...
    if( !$subscriptionId ||
      ...
      return $this->_helper->touchRedirector->gotoRoute(array('action' => 'choose'));
    }
  ...
  public function processAction()
  {
    ...
    if( $transactionMethod == 'GET' ) {
      ...
      return $this->_helper->touchRedirector->gotoUrl($transactionUrl, array('prependBase' => false));
    }
  ...
  protected function _finishPayment($state = 'active')
  {
    ...
    if( $state == 'free' ) {
      ...
      return $this->_helper->touchRedirector->gotoRoute(array('action' => 'finish', 'state' => $state));
    }
  }
}