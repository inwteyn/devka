 ...
 * @license    http://www.socialengine.net/license/
 */
class Music_SongController extends Touch_Controller_Action_Standard
{
  ...
  public function tallyAction()
  {
    ...
    $this->view->play_count = vsprintf(Zend_Registry::get('Zend_Translate')->_(array('%s play', '%s plays', $song->play_count)),
