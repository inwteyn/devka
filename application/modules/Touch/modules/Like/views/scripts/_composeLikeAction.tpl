 ...
 * @version    $Id: _composeLikeAction.tpl 2011-04-26 11:18:13 mirlan $
 * @author     Mirlan
 */
...
<div class="like_action_container">
	<div class="left">
		<?php echo $this->htmlLink($this->object->getHref(), $this->itemPhoto($this->object, 'thumb.profile', '', array('height' => '100px')), array('class'=>'touchajax')); ?>
	</div>
	<div class="right">
		<div class="top">
			<?php echo $this->htmlLink($this->object->getHref(), $this->object->getTitle(), array('class'=>'touchajax')); ?>
		</div>
		<div class="desc">
			<?php
		...
		<?php if ($friendCount > 0): ?>
			<div class="likes">
				...
				<div class="item">
					<?php echo $this->htmlLink($user->getHref(), $this->itemPhoto($user, 'thumb.icon', '', array('width' => '100px', 'height' => '100px')), array('class' => 'like_action_tip_'.$this->object->getGuid(), 'id' => $this->object->getGuid().'_like_action_item_'.$user->getGuid(), 'class'=>'touchajax')); ?>
				</div>
				<?php endforeach; ?>
				<div class="clr"></div>
			</div>
