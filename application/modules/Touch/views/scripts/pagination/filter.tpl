 ...
 * @version    $Id: filter.tpl 2011-04-26 11:18:13 mirlan $
 * @author     Mirlan
 */
...
?>
<form action="<?php echo $this->filterUrl; ?>" method="post" enctype="multipart/form-data" id = "search_form">
...
<div class="global_form_box" id="filter_form">
	<div class="form-elements">
        ...
        <table width="100%" class="filter_text_container"><tr><td width="100%">
          <input type="text"
                 onchange="Touch.filter($(this), '<?php echo $this->filterUrl ?>', false, <?php echo $filterOptions?>, $('search_form'))"
                 ...
                 value="<?php echo (Engine_String::strlen(trim($this->search)) == 0)? $this->filter_default_value: $this->search; ?>" id="search" name=<?php if($this->modulename=='article' && $this->version>= '4.1.0') echo "keyword"; else echo "search" ?>>
          <input type="hidden" name="keyword"/>
        </td><td>
          <a href="javascript:void(0);" onclick="Touch.focus($('search'), 'filter_default_value');Touch.filter($('search'), '<?php echo $this->filterUrl ?>', false, <?php echo $filterOptions?>, $('search_form'));"></a>
        </td></table>
			</td>
			<td class="filter_submit"  valign="middle">
              ...
              if($this->layout()->orientation == 'right-to-left'){
                ...
                <td class="filter_previous" valign="middle">
                         ...
                         ?>
         								<a href="<?php echo $url; ?>" onclick="Touch.filter($(this), false, '<?php echo $this->search; ?>', <?php echo $filterOptions?>, $('search_form')); return false;">
