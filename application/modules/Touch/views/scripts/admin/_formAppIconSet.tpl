...
<!--    --><?php  //echo $this->itemPhoto($this->subject(), 'thumb.profile', "", array('id' => 'lassoImg')); ?>
    ...
    <?php echo $this->htmlImage($this->homeScreen()->getLinkOriginal(), $this->translate('TOUCH_HOMESCREEN_Original Image'), array('title' => $this->translate('TOUCH_HOMESCREEN_Original Image'), 'id' => 'lassoImg')) ?>
  </div>
  <br />
