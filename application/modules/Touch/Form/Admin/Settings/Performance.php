...
class Touch_Form_Admin_Settings_Performance extends Engine_Form
{
  public function init()
  {
    ...
    if (APPLICATION_ENV != 'production') {
      ...
      $this->addError('TOUCH_Note: Your site is in development mode. So all previous client side caches will be cleared at each page refresh.');
    }

    $this->addElement('Radio', 'enable', array(
      'label' => 'TOUCH_Use Client Side Cache?',
    ...
    $this->addElement('Text', 'min_lifetime', array(
      'label' => 'TOUCH_Cache Minimum Lifetime',
    ...
    $this->addElement('Text', 'max_lifetime', array(
      'label' => 'TOUCH_Cache Maximum Lifetime',
