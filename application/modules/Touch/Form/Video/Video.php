...
class Touch_Form_Video_Video extends Touch_Form_Standard
{
  ...
  public function saveValues()
  {
    ...
    $action = $api->addActivity(Engine_Api::_()->user()->getViewer(), $album, 'album_photo_new', null, array('count' => count($values['file']), 'is_mobile' => true));
