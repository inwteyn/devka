 ...
 * @version    $Id: Account.php 2011-04-26 11:18:13 mirlan $
 * @author     Mirlan
 */
...
class Touch_Form_Signup_Account extends Engine_Form
{
  public function init()
  {
    ...
    if(count($options)>1){
      ...
      $languageNameList = array_keys($languageNameList);
      $languageNameList = $languageNameList[0];
