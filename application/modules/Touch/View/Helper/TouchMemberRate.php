 ...
 * @version    $Id: TouchItemRate.php 2011-02-14 06:58:57 said $
 * @author     Said
 */
...
class Touch_View_Helper_TouchMemberRate extends Engine_View_Helper_HtmlElement
{
  public function touchMemberRate($item_type, $item_id, $show_score = false, $score_br = true)
  {
    if (!Engine_Api::_()->touch()->isModuleEnabled('rate')) {
      return '';
    }
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('touch.member.rate-browse', 1)) {
      return '';
    }
