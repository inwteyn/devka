 ...
 */
class Touch_View_Helper_HomeScreen extends Zend_View_Helper_Abstract
{
  private $_path = '/public/touch/homescreen/';
  ...
  private function hasHomeScreen($nochache = false){
    $hs = Engine_Api::_()->getDbTable('settings', 'core')->getSetting('touch.homescreen.extension', false);
    if($hs!== false){
      $this->_extension = $hs;
      $hs = true;
    }
  ...
  public function render(){
    if(Engine_Api::_()->getDbTable('settings', 'core')->getSetting('touch.homescreen.enabled', false))
