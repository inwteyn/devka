...
class Touch_View_Helper_TouchEventRate extends Engine_View_Helper_HtmlElement
{
  public function touchEventRate($item_type, $item_id, $show_score = false, $score_br = true)
  {
    if (!Engine_Api::_()->touch()->isModuleEnabled('rate')) {
      return '';
    }
    if (!Engine_Api::_()->getApi('settings', 'core')->getSetting('touch.event.rate-browse', 1)) {
      return '';
    }
