...
<head>
    ...
    print_log('css isTable - _' . Engine_Api::_()->apptouch()->isTabletMode() . '_');
...
$isDev = APPLICATION_ENV == 'development' ||
    ...
    Engine_Api::_()->getDbTable('settings', 'core')->getSetting('apptouch.use.dev.scripts', false);  // HOSTISO & CLOUD-FLARE EXCEPTION
...
if(array_key_exists('HTTP_USER_AGENT', $_SERVER) && preg_match("/trident\/(4|3)/i", strtolower($_SERVER['HTTP_USER_AGENT'])))
    ...
    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/' . $envDir . 'ie.js?nocache=' . (rand(0,10000)));



echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/' . $envDir . 'picup.js?nocache=' . (rand(0,10000)));

if(true){

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/jquery.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/jquery.mobile-1.2.0.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/eikooc.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/photoswipe/lib/klass.min.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/photoswipe/code.photoswipe.jquery-3.0.4.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/jqmWidgets.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/core.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/initializers.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/components.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/activity.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/iscroll.js?nocache=' . (rand(0,10000)));

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/dev/chat.js?nocache=' . (rand(0,10000)));

}else

    echo $this->apptouchScript($baseUrl . '/application/modules/Apptouch/externals/scripts/js.js?nocache=' . (rand(0,10000)));
