      ...
      <?php if (!empty($actionFormat['attachments'])):?>
        <?php if (count($actionFormat['attachments']) == 1):?>
          ...
          <?php if (!empty($attachment['title'])): ?>
            <div class="attachment-link-title title"><a href="<?php echo $attachment['href'];?>"><?php echo $attachment['title'];?></a></div>
          <?php endif;?>
  ...
  <?php if (!empty($actionFormat['attachments'])):?>
    <?php if (count($actionFormat['attachments']) == 1):?>
      ...
      <div class="attachment_small_photo">
        <?php if (!empty($attachment['photo']) && $actionFormat['parent_type'] != 'stickers') {?>
          <a href="<?php echo $attachment['href'];?>">
            <img src="<?php echo $attachment['photo']['full'];?>" alt=""/>
          </a>
        <?php }else{?>
              <a href="<?php echo $attachment['href'];?>">
                  <img style="width: 20%; margin: 0;" src="<?php echo $attachment['photo']['full'];?>" alt=""/>
              </a>
        <?php };?>
      </div>
    <?php else :?>
  ...
  <?php endif;?>
    ...
    <div class="options">
      <div class="right">
        ...
        <a href="<?php echo $actionFormat['href'];?>" item-id="<?php echo $actionFormat['id'];?>" item-type="activity_action" href="javascript:void(0)" class="btn wall-event"><i class="ui-icon-comment-alt"></i><?php echo $this->translate('Comment');?></a>
        <?php endif;?>
