 ...
 * @license    http://www.socialengine.com/license/
 */
class Apptouch_Form_SeAlbum extends Engine_Form
{
  public function init()
  {
    ...
    $text = new Zend_Form_Element_Text('advOptions');
    $text->setValue('<div class="ui-btn ui-shadow ui-btn-corner-all ui-btn-up-d">
    <span class="ui-btn-inner ui-btn-corner-all">'.Zend_Registry::get("Zend_Translate")->_("Advanced options").'
    <span class="ui-icon ui-icon-arrow-d ui-icon-shadow">&nbsp;</span></span></div>')
          ->helper = 'formNote';
