    ...
    public function indexIndexAction()
    {
        ...
        foreach ($categories as $category) {
            ...
            $this
                ...
                ->add($this->component()->itemList(Zend_Paginator::factory($forums[$category->category_id])->setItemCountPerPage(100), 'forumCustomize'));
...
//  TopicController {
    ...
    public function topicDeleteAction()
    {
        ...
        $this->redirect($forum, array(Zend_Registry::get('Zend_Translate')->_('Topic deleted.')));
    ...
    public function topicRenameAction()
    {
        ...
        $this->redirect($topic, array(Zend_Registry::get('Zend_Translate')->_('Topic renamed.')));
    ...
    public function topicMoveAction()
    {
        ...
        $this->redirect($topic, array(Zend_Registry::get('Zend_Translate')->_('Topic moved.')));
    }
