  ...
  extends Apptouch_Controller_Action_Bridge
{
  ...
  public function indexContactsAction()
  {
    ...
    if ($isFriended) {
      ...
      $this->redirect('parentRefresh', array(Zend_Registry::get('Zend_Translate')->_('All of your friends are allready friends of this friend.')));
    }
  }
  ...
  public function indexSuggestPhotoAction()
  {
    ...
    $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_($message)));
  }
