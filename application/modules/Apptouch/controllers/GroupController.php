...
//  Index Controller {
  ...
  public function indexBrowseAction()
  {
    ...
    // Check create
    $canCreate = false;//Engine_Api::_()->authorization()->isAllowed('group', null, 'create');
...
//        ->add($this->component()->paginator($paginator))
      ...
      $this->add($this->component()->tip(
        $this->view->translate('Be the first to %1$screate%2$s one!', '<a href="'.$this->view->url(array('action'=>'create'), 'group_general').'">', '</a>'),
        $this->view->translate('APPTOUCH_Nobody has created  a group with that criteria.')
      ));
    } else {
      $title = null;
      ...
      if($canCreate){
        $message = $this->view->translate('Why don\'t you %1$screate one%2$s?',
                    '<a href="'.$this->view->url(array('action' => 'create'), 'group_general').'">', '</a>');
        $title = $this->view->translate('You have not joined any groups yet.');
      }
      else
        $message = $this->view->translate('You have not joined any groups yet.');
      $this->add($this->component()->tip(
        $message,
        $title
      ));
  ...
  {
//    $this->redirect($this->view->url(array(), 'group_general', 1));
//    return;
...
//  Member Controller {
  ...
  public function memberJoinAction()
  {
    ...
    if ($subject->membership()->isMember($viewer)) {
      ...
      return $this->redirect($subject->getHref(), array(Zend_Registry::get('Zend_Translate')->_('You are already a member of this group.')));
    }
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('You are now a member of this group.')));
    }
  }
  ...
  public function memberRequestAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Group membership request sent')));
    } else {
      $this->add($this->component()->form($form))
        ->renderContent();
    }
  ...
  public function memberCancelAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Group membership request cancelled.')));
    } else
      $this->add($this->component()->form($form))
        ->renderContent();
  ...
  public function memberLeaveAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect($subject->getHref(), array(Zend_Registry::get('Zend_Translate')->_('You have successfully left this group.')));
    } else
      $this->add($this->component()->form($form))
        ->renderContent();
  }
  ...
  public function memberPromoteAction()
  {
    ...
    return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Member Promoted')));
  }
  ...
  public function memberDemoteAction()
  {
    ...
    return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Member Demoted')));
  }
  ...
  public function memberRemoveAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Group member removed.')));
    } else
      $this->add($this->component()->form($form))
        ->renderContent();
  ...
  public function memberInviteAction()
  {
    ...
    if ($count == 0)
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('You have no friends you can invite.')));
    // Not posting
    if (!$this->getRequest()->isPost()) {
      $this->add($this->component()->form($form))
        ->renderContent();
  ...
  public function memberApproveAction()
  {
    ...
    if ($this->getRequest()->isPost() && $form->isValid($this->getRequest()->getPost())) {
      ...
      return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Group request approved')));
  ...
  public function memberEditAction()
  {
    ...
    return $this->redirect('refresh', array(Zend_Registry::get('Zend_Translate')->_('Member title changed')));
  }
...
//          ->add($this->component()->paginator($paginator), 9)
  ...
  public function groupDeleteAction()
  {
    ...
    return $this->redirect(Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => 'manage'), 'group_general', true), array(Zend_Registry::get('Zend_Translate')->_('The selected group has been deleted.'), true));
  }
  ...
  public function photoDeleteAction()
  {
    ...
    return $this->redirect($group, array(Zend_Registry::get('Zend_Translate')->_('Photo deleted')));
  }
  ...
  public function postEditAction()
  {
    ...
    // Try to get topic
    return $this->redirect($topic, array(Zend_Registry::get('Zend_Translate')->_('The changes to your post have been saved.')));
  }
...
//      ->add($this->component()->paginator($paginator))
  ...
  public function topicDeleteAction()
  {
    ...
    return $this->redirect($group, array(Zend_Registry::get('Zend_Translate')->_('Topic deleted.')));
  }
