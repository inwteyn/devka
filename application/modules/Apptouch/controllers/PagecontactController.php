...
class Apptouch_PagecontactController extends Apptouch_Controller_Action_Bridge
{
  ...
  public function indexSendAction()
  {
    ...
    return $this->redirect($this->view->url(array('page_id' => $this->pageObject->url, 'tab' => 'contact'), 'page_view'), array($this->view->translate('PAGECONTACT_Message has been sent successfully.')));
  }
