...
//      ->add($this->component()->paginator($paginator))
  ...
  public function indexDeleteAction()
  {
    ...
    return $this->redirect($this->view->url(array('page_id' => $page->url, 'tab' => 'document'), 'page_view'), array(Zend_Registry::get('Zend_Translate')->_("pagedocument_Document deleted"), true));
  }
