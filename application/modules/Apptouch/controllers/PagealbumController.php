...
//      ->add($this->component()->paginator($albums))
  ...
  public function indexDeleteAction()
  {
    ...
    return $this->redirect($this->view->url(array('module' => 'pagealbum', 'controller' => 'index', 'action' => 'mine', 'page_id' => $page->getIdentity()), 'default'), array(Zend_Registry::get('Zend_Translate')->_("Album was deleted."), true));
  }
