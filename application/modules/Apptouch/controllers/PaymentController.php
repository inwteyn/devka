...
class Apptouch_PaymentController extends Apptouch_Controller_Action_Bridge
{
  ...
  public function settingsConfirmAction()
  {
    ...
    public function subscriptionChooseAction()
    {
        ...
        // Make form
        $form = new Payment_Form_Signup_Subscription(array(
            'isSignup' => false,
    ...
    public function subscriptionGatewayAction()
    {
        ...
        $title = '<h3>' . $this->view->translate('Pay for Access') . '</h3>';
        ...
        if ($package->recurrence) {
            $recurrence = $this->view->translate('Please setup your subscription to continue:' . $package->getPackageDescription());
        } else {
            $recurrence = $this->view->translate('Please pay a one-time fee to continue:');
        }
        $this->add($this->component()->html($title));
        $this->add($this->component()->html($description));
        $this->add($this->component()->html($recurrence));
