...
class Apptouch_Installer extends Engine_Package_Installer_Module
{
  public function onPreInstall()
  {
    ...
    if ($operation == 'install') {
      ...
      if ($store && $store['enabled'] && version_compare($store['version'], '4.2.8') < 0) {
        $error_message = $translate->_('We found that you has old version of Hire-Experts Store Plugin, please download latest version of Store Plugin and upgrade.');
        return $this->_error($error_message);
      }
