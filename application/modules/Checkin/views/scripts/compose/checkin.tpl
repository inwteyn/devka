...
<script type="text/javascript">
  ...
  Wall.runonce.add(function (){
      if(window.__ccas == true) return;
      window.__ccas = true;
      var feed = Wall.feeds.get("<?php echo $this->feed_uid?>");
      var checkin = new Wall.Composer.Plugin.Checkin({}, <?php echo ($this->subject()) ? $this->checkinDefaultLocation($this->subject()) : $this->checkinDefaultLocation($this->viewer()) ?>);
...
<div class="display_none">
  <div class="checkinWallShareLocation">
    <a class="checkinShareLoc wall_liketips hei hei-map-marker" href="javascript://" rev="checkin"></a>
    ...
    <a class="checkinClear wall_liketips hei hei-times" href="javascript://" rev="checkin"></a>
