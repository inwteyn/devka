...
class Pinfeed_Form_Admin_Settings_Global extends Engine_Form {
  public function init()
  {
    ...
    $this->addElement('Select', 'profile', array(
      'label' => 'Replace standard Profile Page to the Pin Feed',
      'description' => 'Replaces standard Profile Page on a beautiful new Pin Feed',
      'multiOptions' => array(
        '1' => 'Yes, use Pin Feed profile page',
        '0' => 'No, use default Profile page',
      ),
    ));
