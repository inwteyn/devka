...
<?php
$canComment = ($this->action->getTypeInfo()->commentable && $this->viewer()->getIdentity() && Engine_Api::_()->authorization()->isAllowed($this->action->getObject(), null, 'comment') &&
...
<?php if ($this->action->getTypeInfo()->commentable): // Comments - likes ?>
    ...
    <?php if ($this->comment_pagination): ?>
        ...
        <?php if (isset($paginator->getPages()->next)): ?>
            <li class="pagination">
                <a href="javascript:void(0);" class="comment_next"
                   rev="item_<?php echo $paginator->getPages()->next ?>"><?php echo $this->translate('WALL_COMMENT_NEXT') ?></a>
    ...
    <?php if ($comments): ?>
        ...
        <?php foreach ($comments as $comment): ?>
            <li rev="item-<?php echo $comment->comment_id ?>" class="wall-comment-item"
          ...
          <?php endif; ?>
                    ...
                    <div class="comments_date">
                        ...
                        <?php if ($editable && $this->viewer()->getIdentity() == $comment->poster_id): ?>
                        ...
                        <?php if ($this->viewer()->getIdentity() &&
                            ...
                            - <a href="javascript:void(0);"
                                 class="comment-remove"><?php echo $this->translate('Delete') ?></a>
                        <?php endif; ?>

                        <?php if ($comment->likes()->getLikeCount() > 0): ?>
                            -
                            <a href="<?php echo $this->url(array('controller' => 'items', 'fn' => 'like', 'm' => 'wall', 'subject' => $comment->getGuid()), 'wall_extended', true) ?>"
                ...
                <div class="comment-form-reply" id="comment-form-reply_<?php echo $comment->getIdentity() ?>"
                    ...
                    ?>
                    <div id="preview_comment_attach_wall" style="margin: 0px">
                ...
                echo $this->render('_commentsReply.tpl'); ?>
