...
class Heloginpopup_Plugin_Core
{
    public function onRenderLayoutDefault($event)
    {
        ...
        if (($module == 'user' && $controller == 'auth' && $action == 'login') || ($module == 'user' && $controller == 'signup') || ($module == 'user' && $controller == 'auth' && $action == 'forgot') || ($module == 'heloginpopup' && $controller == 'index' && $action == 'index') || ($module == 'user' && $controller == 'auth' && $action == 'reset')) {
            return;
        }
        ...
        $forgotUrl = $router->assemble(array('module' => 'user', 'controller' => 'auth', 'action' => 'forgot'), 'default', true);
        $signupUrl = $router->assemble(array(), 'user_signup', true);
        $facebookUrl = $router->assemble(array('module' => 'heloginpopup', 'controller' => 'index', 'action' => 'facebook'), 'default', true);
        $twitterUrl = $router->assemble(array('module' => 'user', 'controller' => 'auth', 'action' => 'twitter'), 'default', true);
