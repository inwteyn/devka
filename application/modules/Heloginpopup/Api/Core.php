...
class Heloginpopup_Api_Core extends Core_Api_Abstract
{
  public function facebookLoginButton($connect_text = 'Connect with Facebook')
  {
    ...
    return '<a target="_top" href="'.$href.'" class="heloginpopup_socialbutton facebook-connect"><span class="fontawesome-facebook"></span></a>';
  }
  ...
  public function twitterLoginButton($connect_text = 'Sign-in with Twitter')
  {
    ...
    return '<a target="_top" href="'.$href.'" class="heloginpopup_socialbutton twitter-connect"><span class="fontawesome-twitter"></span></a>';
  }
