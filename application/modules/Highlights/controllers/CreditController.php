 ...
 */
class Highlights_CreditController extends Core_Controller_Action_User
{
  ...
  public function profileAction()
  {
      ...
      try {
          ...
          $viewer2 = Engine_Api::_()->user()->getUser($this->_getParam('id'));

          $activityApi->addActivity($viewer,$viewer2, 'highlights','owner');
