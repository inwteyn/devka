...
class Highlights_Installer extends Engine_Package_Installer_Module
{
  public function onPreInstall()
  {
    ...
    if (!empty($credit) && version_compare($credit['version'], '4.2.8') < 0) {
      $error_message = $translate->_('This plugin requires Hire-Experts Credit Module. We found that you has old version of Credit module, please download latest version of Hire-Experts Credit Module and install.');
      return $this->_error($error_message);
    }
