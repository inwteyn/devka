...
<h3><?php echo $this->translate('Most Popular Surveys'); ?></h3>
...
<li class="he_survey_block">
  ...
  <div class="he_survey_info">
    ...
    <div class="he_survey_misc">
     <?php echo $this->translate(array('survey_<b>%s</b> view', '<b>%s</b> views', $survey->view_count), '<span class="he_survey_misc_important">' . $survey->view_count . '</span>') ?>
    </div>
  </div>
</li>
<?php endforeach; ?>
