...
<h2><?php echo $this->translate("Surveyzes Plugin"); ?></h2>
...
<p>
  <?php echo $this->translate("List of surveyzes."); ?>
</p>
          ...
          <tr>
            ...
            <td>
              <?php if($item->approved == 0):?>
                ...
                <?php else: ?>
		        	  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'survey', 'controller' => 'surveyzes', 'action' => 'approve', 'survey_id' => $item->survey_id, 'page' => $this->page), $this->translate("survey_approve"), array('title'=> $this->translate('Click to approve this survey'))) ?>
                <?php endif; ?>
		          <?php else: ?>
              <?php if(_ENGINE_ADMIN_NEUTER): ?>
                ...
                <?php else: ?>
							  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'survey', 'controller' => 'surveyzes', 'action' => 'approve', 'survey_id' => $item->survey_id, 'page' => $this->page), $this->translate("survey_disapprove"), array('title'=> $this->translate('Click to disapprove this survey'))) ?>
                <?php endif; ?>
		          <?php endif; ?>
              |
...
<?php else:?>
  <?php echo $this->translate("There are no surveyzes by your members yet."); ?>
<?php endif; ?>