...
if(USE_CCAUTH == '1'){
  include_once(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."cometchat".DIRECTORY_SEPARATOR."ccauth.php");
  $guestsMode = '0';
}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
include_once(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."cometchat".DIRECTORY_SEPARATOR."plugins".DIRECTORY_SEPARATOR.'smilies'.DIRECTORY_SEPARATOR.'config.php');
...
$blockpluginmode = '0';  // If yes, you want to show blocked users in Who's Online list
...
if (CROSS_DOMAIN == 0){
  ...
  define('CC_SITE_URL', 'chat_a');         // Enter Site URL only if Cross Domain is enabled.
}
...
include_once(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."cometchat".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR.'en.php');
if (file_exists(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."cometchat".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR.$lang.'.php')) {
  include_once(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR."cometchat".DIRECTORY_SEPARATOR."lang".DIRECTORY_SEPARATOR.$lang.'.php');
}
