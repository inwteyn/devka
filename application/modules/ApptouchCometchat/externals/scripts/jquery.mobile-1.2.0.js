...
(function (root, doc, factory) {
    ...
    (function ($, window) {
        ...
        $.extend($.mobile, {
            ...
            showPageLoadingMsg: function (theme, msgText, textonly) {
                ...
                if (msgText) {
                    //window.plugins.Loader.hideLoader();
                    window.NativeCore.showLoader();
                    $.mobile.loading('show', theme, msgText, textonly);
                } else {
                    window.NativeCore.showLoader();
                    //window.plugins.Loader.showLoader();
                }
    ...
    (function ($, undefined) {
        ...
        $.mobile.changePage = function (toPage, options) {
          if ('string' == typeof toPage && toPage.indexOf('.html') != -1 ) {
            return;
          }
          ...
          window.NativeCore.hideComposer();
            ...
            if (!historyDir) {
                ...
                //alert("Place 1, url-"+pageUrl);
                //console.log(settings.dataUrl);
                //console.log(path.convertUrlToDataUrl(settings.dataUrl));
                //console.log(toPage.jqmData("url"));
            ...
            transitionPages(toPage, fromPage, settings.transition, settings.reverse)
                .done(function (name, reverse, $to, $from, alreadyFocused) {
                    ...
                    window.NativeCore.switchComposer();
