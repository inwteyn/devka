...
Wall.request = function (url, data, callback) {
    var isT = document.tl_core.isTimeline();
    if (typeof(data) == 'object') {
        data.format = 'json';
        data.is_timeline = isT;
...
Wall.requestHTML = function (url, callback, $container, data) {
    ...
    data.is_timeline = document.tl_core.isTimeline();
...
Wall.Composer = new Class({
    ...
    initialize: function (options) {
        ...
        this.getForm().addEvent('submit', function (e) {
            ...
            if (feed.compose.getContent().trim() == '' && !this.pluginReady && !this.ready && (!this.getPlugin('people') || !this.getPlugin('people').peoples.length)) {
                return;
            }
    ...
    open: function (callback) {
        ...
        fx.start({'height': [70, 100]}).chain(function () {
    ...
    close: function () {
      ...
      fx.addEvent('onStart', function () {
        ...
        fx.start({'height': [100, 70]}).chain(function () {
            if (feed.compose.is_timeline) {
