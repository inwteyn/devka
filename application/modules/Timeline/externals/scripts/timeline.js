...
var TimeLine = new Class({
    ...
    separator:{
        ...
        add:function (params, el) {
            ...
            var li = new Element('li', {'id':this.prefix + params['date'], 'class':'sep ' + params['class'] + ' timeline_sep_he'});
...
//      }
    ...
    scroller:{
        ...
        checkPosition:function () {
            ...
            var y = $('global_content').getSize().x;
            var right = ((x-y)/2)-70;
            var  top_ab  = y = $('global_header').getSize().y+15;

            scroller.morph({
                duration: 100,'position':'fixed', 'top':top_ab+'px',right:right+'px'
            });
