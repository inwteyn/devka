...
<?php if($this->no_birthdate) : ?>
    <script type="text/javascript">
        window.addEvent('load', function() {
            he_show_message("<?php echo $this->no_birthdate_message?>", '', 15000);
        });
    </script>
<?php endif; ?>
...
<div class="additional-row" id="additional-row">
  ...
  <div class="about">
      <?php
         if(!$this->hide_profile_fields) {
             echo $this->content()->renderWidget('user.profile-fields');
             echo $this->htmlLink('javascript://', $this->translate('Personal Information'), array('title' => $this->subject()->getTitle()));
         }
      ?>
  </div>
