...
$user = Engine_Api::_()->getItem('user', $request->getParam('id'));
?>
...
<?php if( $user->photo_id !== null ): ?>
    ...
    ?>
    <div>
        <?php echo $this->itemPhoto($user, 'thumb.profile', "", array('id' => 'lassoImg')) ?>
    </div>
    <br />
    <div id="preview-thumbnail" class="preview-thumbnail">
        <?php echo $this->itemPhoto($user, 'thumb.icon', "", array('id' => 'previewimage')) ?>
    </div>
