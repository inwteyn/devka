...
$page = Engine_Api::_()->getItem('page', $request->getParam('id'));
?>

<?php if( $page->photo_id !== null ): ?>
    ...
    ?>
    <div>
        <?php echo $this->itemPhoto($page, 'thumb.profile', "", array('id' => 'lassoImg')) ?>
    </div>
    <br />
    <div id="preview-thumbnail" class="preview-thumbnail">
        <?php echo $this->itemPhoto($page, 'thumb.icon', "", array('id' => 'previewimage')) ?>
    </div>
    <div id="thumbnail-controller" class="thumbnail-controller">
        <?php if ($page->getPhotoUrl())
