<?php return array(
    ...
    'hooks' => array(
        ...
        array(
            'event' => 'onSubjectTimelinePhotoUpload',
            'resource' => 'Timeline_Plugin_Core'
        ),
        array(
...
// Timeline Page
        ...
        'timeline_profile_photo' => array(
            'route' => 'timeline/profile-photo/:action/*',
            'defaults' => array(
                'module' => 'timeline',
            ...
            'reqs' => array(
                'action' => '(edit-user-photo|edit-page-photo)',
            )
        ),
    ),
); ?>