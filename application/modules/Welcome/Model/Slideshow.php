...
<?php
  ...
  class Welcome_Model_Slideshow extends Core_Model_Item_Abstract
  {
    ...
    public function getRecommendedSize()
    {
      ...
      switch( $this->effect ){
        case 'slider':
          $width = $this->width <= 22 ? $this->width : $this->width - 22;
          $height = $this->height <= 68 ? $this->height : $this->height - 68;
          break;
        case 'tabs':
          $width = $this->width <= 40 ? $this->width : $this->width - 40;
          $height = $this->height <= 102 ? $this->height : $this->height - 102;
          break;
        case 'popup':
          $width = $this->width <= 40 * $this->getSlides()->length ? $this->width : $this->width - 40 * $this->getSlides()->length;
          $height = $this->height <= 22 ? $this->height : $this->height - 22;
          break;
        case 'curtain':
          $width = $this->width <= 20 ? $this->width : $this->width - 20;
          $height = $this->height <= 20 ? $this->height : $this->height - 20;
          break;
        case 'carousel':
          $width = $this->width;
          $height = $this->height;
    ...
    public function getRecommendedWidth()
    {
      ...
      switch( $this->effect ){
        case 'slider':
          return $this->width <= 22 ? $this->width : $this->width - 22;
        case 'tabs':
          return $this->width <= 40 ? $this->width : $this->width - 40;
        case 'popup':
          return $this->width <= 40 * $this->getSlides()->length ? $this->width : $this->width - 40 * $this->getSlides()->length;
        case 'curtain':
          return $this->width <= 20 ? $this->width : $this->width - 20;
        case 'carousel':
          return $this->width;
        case 'kenburns':
          return $this->width;
    ...
    public function getRecommendedHeight()
    {
      ...
      switch( $this->effect ){
        case 'slider':
          return $this->height <= 68 ? $this->height : $this->height - 68;
        case 'tabs':
          return $this->height <= 102 ? $this->height : $this->height - 102;
        case 'popup':
          return $this->height <= 22 ? $this->height : $this->height - 22;
        case 'curtain':
          return $this->height <= 20 ? $this->height : $this->height - 20;
        case 'carousel':
          return $this->height;
        case 'kenburns':
          return $this->height;
