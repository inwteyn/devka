...
class Inviter_Widget_FacebookSuggestController extends Engine_Content_Widget_Abstract
{
    ...
    public function indexAction()
    {
        ...
        $this->view->providers = $providers = Engine_Api::_()->inviter()->getIntegratedProviders(false);
        ...
        $ipp = $this->_getParam('itemCountPerPage', 1);
        $fb_users = $providerApi->getNoneMemberContacts($token, $this->provider, $ipp);
        ...
        $this->view->friends = $fb_friends = Zend_Paginator::factory($fbUsers);
        $fb_friends->setItemCountPerPage($ipp);
