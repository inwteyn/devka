...
<div id="<?php echo $widget_uid; ?>">
    <a onclick="InviterIntroduce.hideMoreFriends('<?php echo $widget_uid; ?>')" class="hide_introduce_btn"
       href="javascript://"></a>
    ...
    <div class="inviter_more_friends_items">
      ...
      <div class="inviter_tip_text display_none"><?php echo $item->getTitle(); ?></div>
            ...
            <?php endforeach; ?>
        <?php else : ?>
            <img class="inviter_more_friends_provider"
                 src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Inviter/externals/images/providers_icons/fb.png"
                 title="Facebook"/>
            <img class="inviter_more_friends_provider"
                 src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Inviter/externals/images/providers_icons/tw.png"
                 title="Twitter"/>
            <img class="inviter_more_friends_provider"
                 src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Inviter/externals/images/providers_icons/gm.png"
                 title="GMail"/>
            <img class="inviter_more_friends_provider"
                 src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Inviter/externals/images/providers_icons/hm.png"
                 title="Live/Hotmail"/>
            <img class="inviter_more_friends_provider"
                 src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Inviter/externals/images/providers_icons/ya.png"
                 title="Yahoo!"/>
        <?php endif; ?>
        <div class="clr"></div>
    </div>
    ...
    <div class="inviter_more_friends_desc">
        ...
        if ($this->item_count) {
            if ($this->item_count > 1) {
                $lang = $this->translate('INVITER_%s Friends', $this->item_count);
            } else {
                $lang = $this->translate('INVITER_Friend');
            }
            $friends_link = $this->htmlLink('javascript://', $lang, array(
    ...
    <button
        onclick="window.location.href = '<?php echo $this->url(array(), 'inviter_general') ?>'"><?php echo $this->translate('INVITER_Find Friends'); ?></button>
    <br/>
</div>
