...
class Inviter_Installer extends Engine_Package_Installer_Module
{
  ...
  {
    $db = $this->getDb();
    $db->query("UPDATE `engine4_user_signup` SET `enable`= 1 WHERE `engine4_user_signup`.`class` = 'Inviter_Plugin_Signup_Invite';");
    parent::onEnable();
  }
  ...
  {
    $db = $this->getDb();
    $db->query("UPDATE `engine4_user_signup` SET `enable`= 0 WHERE `engine4_user_signup`.`class` = 'Inviter_Plugin_Signup_Invite';");
    parent::onDisable();
  }
}