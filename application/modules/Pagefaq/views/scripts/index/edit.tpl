...
<?php $this->headScript()->appendFile('application/modules/Pagefaq/externals/scripts/core.js'); ?>
              ...
              <tr>
                <td valign="top">
                  <div class="box_faq_class">
                    <a href="javascript:void(0)" class="delete_faq_class" title="<?php echo $this->translate('PAGEFAQ_Delete'); ?>"><img src="application/modules/Page/externals/images/remove.png" alt="Delete"></a>
                    <a href="javascript:void(0)" class="edit_faq_class" title="<?php echo $this->translate('PAGEFAQ_Edit'); ?>"><img src="application/modules/Pagefaq/externals/images/edit.png" alt="Edit"></a>

                    <p class="question_faq_class"><?php echo $faq->question; ?></p><br/>
          ...
          <tr>
            <td valign="top">
              <div class="box_faq_class">
                ...
                <p class="question_faq_class"></span></p><br/>
