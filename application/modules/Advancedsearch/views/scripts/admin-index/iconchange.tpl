<div class="settings">
  <form method="post">
    ...
    <input type="hidden" name="icon" value="hei hei-globe" id="item_icon">
    <span style="font-size: 22px;margin: 10px 0">
      <?php echo $this->translate('AS_icon')?>: <i id="icon" class="<?php if (isset($this->item['icon'])) echo $this->item['icon']; else echo 'hei hei-globe';?>"></i>
    </span><br>
    <button type="submit">
