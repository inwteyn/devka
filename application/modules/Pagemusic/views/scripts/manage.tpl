 ...
 * @version    $Id: manage.tpl 2010-10-21 17:53 idris $
 * @author     Idris
 */
?>
      ...
      <div class="page-music-browse-item">
        ...
        <div class="page-music-browse-item-info">
          ...
          <p class="label">
            ...
            <?php echo Engine_String::substr($item->getDescription(), 0, 100); ?><br /><br />
          </p>
          <div class="options">
            <a class="edit" href="javascript:page_music.edit(<?php echo $item->getIdentity(); ?>)"></a>
            <a class="delete" href="javascript:page_music.confirm_delete(<?php echo $item->getIdentity(); ?>)"></a>
            <div class="clr"></div>
          </div>
        </div>
      </div>
