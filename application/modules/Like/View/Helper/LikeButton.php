...
HTML;
        ...
        $wrapper .= ' '
            . '<div class="like_button_container"><div id="like_loader_' . $item->getGuid() . '" class="like_button_loader hidden"></div>
      <a ' . $attributes . '  id="_' . $item->getGuid() . '" ' . $onClick . ' onFocus="this.blur();" class="like_button_link ' . $action . '" href="javascript:void(0)"><i class="'. $button .'"></i><span class="' . $class . '">' . $label . '</span></a>';
        ...
        if ($allowed) {
            $wrapper .= '<a class="like_menu_switcher like_button_link" id="like_switcher_' . $item->getGuid() . '" href="javascript:void(0)" onFocus="this.blur();"><span class="show_options">&nbsp;</span></a>';
        }
