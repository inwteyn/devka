...
<div class="promote_like_box">
	...
	<div class="promote_left">
	  <div class="like_desc"><?php echo $this->translate("like_Like Button Code."); ?></div>
		<div class="like_textarea">
			<textarea onfocus="this.select();" cols="10" rows="7" name="like_button_snippet" id="like_button_snippet"><iframe scrolling="no" frameborder="0" style="background:transparent;border:none;overflow:hidden;width:400px;height:40px;" allowTransparency="true" src="<?php echo (_ENGINE_SSL ? 'https' : 'http') . '://'.$_SERVER['HTTP_HOST'].$this->url(array('object' => $this->object, 'object_id' => $this->object_id), 'like_button'); ?>" id="like_button_frame" ></iframe></textarea>
		</div>
	</div>
	
	<div class="promote_right">
		<div class="like_desc"><?php echo $this->translate("like_Like Button Preview:"); ?> </div>
		<iframe scrolling="no" frameborder="0" style="background:transparent;border:none;overflow:hidden;width:400px;height:40px;" allowTransparency="true" src="<?php echo (_ENGINE_SSL ? 'https' : 'http') . '://'.$_SERVER['HTTP_HOST'].$this->url(array('object' => $this->object, 'object_id' => $this->object_id), 'like_button'); ?>" id="like_button_frame" ></iframe>
	</div>
	...
	<div class="promote_left">
		...
		<div class="like_textarea">
			<textarea onfocus="this.select();" cols="10" rows="7" name="like_box_snippet" id="like_box_snippet"><iframe scrolling="no" frameborder="0" style="background:transparent;border:none;overflow:hidden;width:255px;height:310px;" allowTransparency="true" src="<?php echo (_ENGINE_SSL ? 'https' : 'http') . '://'.$_SERVER['HTTP_HOST'].$this->url(array('action' => 'show-like-box', 'object' => $this->object, 'object_id' => $this->object_id), 'show_like_box'); ?>" id="like_box_frame" ></iframe></textarea>
		</div>
	</div>
	
	<div class="promote_right">
		<div class="like_desc"><?php echo $this->translate("like_Like Box Preview:"); ?> </div>
    <iframe scrolling="no" frameborder="0" style="background:transparent;border:none;overflow:hidden;width:255px;height:310px;" allowTransparency="true" src="<?php echo (_ENGINE_SSL ? 'https' : 'http') . '://'.$_SERVER['HTTP_HOST'].$this->url(array('action' => 'show-like-box', 'object' => $this->object, 'object_id' => $this->object_id), 'show_like_box'); ?>" id="like_box_frame" ></iframe>
	</div>
