...
class Hecontest_Widget_ContestPhotosController extends Engine_Content_Widget_Abstract
{
    public function indexAction()
    {
        ...
        $this->view->participants = $participants = $contest->getParticipants(array('status'=>'approved', 'limit'=>3));
