...
<?php elseif($this->step == 'more_link'): ?>
  <div align="right">
    <script type="text/javascript">
       $$('a#new_videos_more_link').setStyle('display', 'none');
     </script>
    <a href="<?php echo $this->url(array('module'=>'videos'), 'default', true); ?>" style="text-decoration:underline;padding-top: 5px;color:<?php echo $this->linkColor; ?>;">
