...
<?php elseif($this->step == 'details'): ?>
  ...
  <div  style="font-weight: bold;  font-size: 12px; text-decoration: none">
    <?php echo $this->translate('Salary ')?>  <?php echo $this->item->getSalary(); ?>
  </div>
...
<?php elseif($this->step == 'more_link'): ?>
  ...
  <div align="right">
    <a id="new_blogs_more_link" href="<?php echo $this->url(array('module'=>'ynjobposting','controller' => 'jobs','action' => 'index'), 'default', false); ?>" style="text-decoration:underline;color:<?php echo $this->linkColor; ?>">
      <?php echo $this->translate('More Jobs...'); ?>
    </a>
  </div>
