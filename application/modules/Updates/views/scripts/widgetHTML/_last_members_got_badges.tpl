...
<?php elseif($this->step == 'details'): ?>
  <div style="margin-top:4px;font-size:10px;width: 50px">
    <a href="<?php echo '/profile/'.$this->item->username; ?>" style="text-decoration:none; color:<?php echo $this->linkColor;?>">
      <?php echo $this->item->displayname; ?>
    </a>
  </div>

<?php elseif($this->step == 'more_link'): ?>
  <div align="right">
    <a href="<?php echo $this->url(array('module'=>'badges'), 'default', true) ?>" style="text-decoration:underline;padding-top: 5px;color:<?php echo $this->linkColor;?> ">
