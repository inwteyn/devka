...
<?php elseif($this->step == 'more_link'): ?>
  ...
  <div align="right">
    <a href="<?php echo $this->url(array('module'=>'classifieds'), 'default', true); ?>" style="text-decoration:underline;color:<?php echo $this->linkColor;?>">
      <?php echo $this->translate('UPDATES_More classifieds...'); ?>
    </a>
  </div>
