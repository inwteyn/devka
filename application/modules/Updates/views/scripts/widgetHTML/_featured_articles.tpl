  ...
  <div>
    ...
    <span>
      <?php if ( $this->item->featured) : ?>
        <img src="/application/modules/Article/externals/images/featured.png" title="<?php echo $this->translate('Featured'); ?>" height="14px"/>
      <?php endif; ?>
      <?php if ($this->item->sponsored) : ?>
        <img src="/application/modules/Article/externals/images/sponsored.png" title="<?php echo $this->translate('Sponsored'); ?>" height="14px"/>
      <?php endif; ?>
    </span>
  </div>
