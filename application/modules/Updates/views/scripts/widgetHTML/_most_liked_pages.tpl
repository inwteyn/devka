...
<?php elseif($this->step == 'details'): ?>
  ...
  <div style="font-size: 10px">
    ...
    <a style="color:<?php echo $this->linkColor ?>; text-decoration: none" href="<?php echo $this->item->getOwner()->getHref();?>">
...
<?php elseif($this->step == 'more_link'): ?>
  <div align="right">
    <a style="text-decoration:underline;padding-top: 5px;color:<?php echo $this->linkColor; ?>" href="<?php echo $this->url(array('module'=>'browse-pages'), 'default', true); ?>">
      <?php echo $this->translate('UPDATES_More pages...'); ?>
    </a>
  </div>
<?php endif; ?>