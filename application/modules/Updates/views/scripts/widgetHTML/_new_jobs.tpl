...
<?php elseif($this->step == 'more_link'): ?>
  ...
  <div align="right">
    <a href="<?php echo $this->url(array('module'=>'jobs', 'controller'=>'browse'), 'default', true); ?>" style="text-decoration:underline;padding-top: 5px;color:<?php echo $this->linkColor; ?>">
      <?php echo $this->translate('UPDATES_More jobs...'); ?>
    </a>
  </div>
