...
<?php elseif($this->step == 'details'): ?>
  ...
  <div style="font-size: 10px">
    ...
    <a target="_blank" href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/page/'.$this->item->url; //echo $this->item->getOwner()->getHref()?>" style="color:<?php echo $this->linkColor ?>; text-decoration: none">
...
<?php elseif($this->step == 'more_link'): ?>
  ...
  <div align="right">
    <script type="text/javascript">
      $$('a#new_events_more_link').setStyle('display', 'none');
    </script>
    <a href="<?php echo $this->url(array('module'=>'events'), 'default', true); ?>" style="text-decoration:underline;color:<?php echo $this->linkColor; ?>">
