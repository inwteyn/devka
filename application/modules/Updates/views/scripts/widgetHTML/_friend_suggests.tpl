...
<?php elseif($this->step == 'more_link'): ?>
  <div align="right">
    <a style="text-decoration:underline;padding-top: 5px;color:<?php echo $this->linkColor;?> " href="<?php echo $this->url(array('module'=>'inviter'), 'default', true) ?>">
      <?php echo $this->translate('UPDATES_More suggests...');?>
    </a>
  </div>
<?php endif; ?>