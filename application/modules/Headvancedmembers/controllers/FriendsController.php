 ...
 * @version    $Id: FriendsController.php 2015-10-06 16:58:20  $
 * @author     Bolot
 */
 ...
 * @license    http://www.hire-experts.com
 */
class Headvancedmembers_FriendsController extends Core_Controller_Action_User
{
  ...
  public function listCreateAction()
  {
    ...
    $this->view->body = $this->view->heuserFriendship($user);
    $this->view->status = true;
  ...
  public function cancelAction()
  {
    ...
    try {
      ...
      if(!$direction){
        $this->view->htmlLink(array('route' => 'user_extended', 'controller' => 'friends', 'action' => 'add', 'user_id' => $user->user_id), $this->view->translate('Follow'), array(
          'class' => 'btn_heuser_list btn-headdfriend headvuser_button'
        ));
      }else{

        $this->view->body = $this->view->htmlLink(array('route' => 'user_extended', 'controller' => 'friends', 'action' => 'add', 'user_id' => $user->user_id), $this->view->translate('Add Friend'), array(
          'class' => 'btn_heuser_list btn-headdfriend headvuser_button'
        ));
      }
