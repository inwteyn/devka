...
class Wall_Form_Service_Linkedin extends Wall_Form_Subform
{
  ...
  public function init()
  {
    ...
    $description = vsprintf($description,
      '"http://' . $_SERVER['HTTP_HOST'] . '/wall/linkedin/index/format/smoothbox/task/stream", "http://' . $_SERVER['HTTP_HOST'] .'/wall/linkedin/index/format/smoothbox/task/share" and "http://' . $_SERVER['HTTP_HOST'] .'/wall/linkedin/index/format/smoothbox/task/activity-share"'
      );
