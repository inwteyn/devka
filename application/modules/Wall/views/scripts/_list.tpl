...
$list_disabled = explode(',', $settings->getSetting('wall.list.disabled', ''));
...
<?php if ($settings->getSetting('wall.content.frendlistenable', true)):?>
...
<?php if ($settings->getSetting('wall.content.listenable', true)):?>
