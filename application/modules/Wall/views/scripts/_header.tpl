...
if ($timeline) {
    $this->headScript()->appendFile($baseUrl . 'application/modules/Timeline/externals/scripts/wall_core.js');
} else {
      $this->headScript()->appendFile($baseUrl . 'application/modules/Wall/externals/scripts/core.js');
    }
...
$this->headScript()
    ...
    ->appendFile($baseUrl . 'application/modules/Wall/externals/webcam/webcam.js')
    ->appendFile($baseUrl . 'application/modules/Hecore/externals/scripts/core.js');
...
?>
  Wall.liketips_enabled = <?php echo (int)$settingCore->getSetting('wall.content.liketips', true)?>;
  Wall.rolldownload = <?php echo (int)$settingCore->getSetting('wall.content.rolldownload', true)?>;
  Wall.dialogConfirm = <?php echo (int)$settingCore->getSetting('wall.content.dialogconfirm', true)?>;
  Wall.autoupdate = <?php echo (int)$settingCore->getSetting('wall.content.autoload', true)?>
