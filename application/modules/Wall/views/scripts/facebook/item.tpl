...
<div class="item_body">
  ...
  <div class="item_line">
    ...
    <ul class="item_options">
      ...
      <?php endif;?>
        <?php $action['likes']['count'] = (isset($action['likes']['count']))?$action['likes']['count']:NULL; ?>
        <?php $action['comments']['count'] = (isset($action['comments']['count']))?$action['comments']['count']:NULL; ?>
