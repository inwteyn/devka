...
$this->headScript()
    ->appendFile($baseUrl . 'application/modules/Wall/externals/scripts/composer_photo.js')
...
$albums = array();
$stmt = $albumsTbl->select()
    ->from($albumsTbl, array('album_id', 'title'))
    ...
    Wall.runonce.add(function () {
        ...
        feed.compose.addPlugin(new Wall.Composer.Plugin.Photo({
            ...
            lang: {
                ...
                'Upload Photos': '<?php echo $this->string()->escapeJavascript($this->translate('Upload Photos')) ?>',
            ...
            user_albums: <?php echo sizeof($albums)?Zend_Json::encode($albums):0; ?>
        }));
