...
<?php
  ...
  $this->headScript()
    ...
    ->appendFile($baseUrl . 'application/modules/Mp3music/externals/scripts/core.js')
    ->appendFile($baseUrl . 'application/modules/Mp3music/externals/scripts/player.js')
    ->appendFile($baseUrl . 'application/modules/Wall/externals/scripts/composer_mp3music.js')
