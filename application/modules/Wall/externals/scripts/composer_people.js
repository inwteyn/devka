...
Wall.Composer.Plugin.People = new Class({
  ...
  show: function ()
  {
    ...
    var create_function = function ()
    {
      ...
      if (!self.init_active){
        ...
        var input = this.input = new Element('textarea', {'class': 'wall_people_text','name': 'people', 'autocomplete': 'off', 'value': en4.core.language.translate('WALL_Who are you with?')});
        ...
        input.addEvent('keyup', function (e){
          ...
          if (!stopped){
            ...
            if (e.key == 'backspace' && $(this).get('value') == ''){
              if (inputPrevValue == '') {
  ...
  composeText: function ()
  {
    ...
    if (this.peoples.length == 0){
      ...
      new_html = ' &mdash; ' + en4.core.language.translate('WALL_with %1$s and %2$s', '<a href="javascript:void(0);">' + this.peoples_info[this.peoples[0]].label + '</a>', '<a href="javascript:void(0);">' + en4.core.language.translate('WALL_%1$s others', this.peoples.length - 1)) + '</a>';
    }
