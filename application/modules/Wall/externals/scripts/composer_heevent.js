/* $Id: composer_composer_question.jsquestion.js 18.06.12 10:52 michael $ */
alert('asdasdasdasdfasfasdg')
Wall.Composer.Plugin.Heevent = new Class({
  ...
  options : {
    title : 'Asdgsdk',
    lang : {},
    requestOptions : {getFormURL : en4.core.baseUrl + 'heevent/wall/getform'},
