 ...
 return array (
  ...
  'items' => array(
   ...
   'wall_tabs' => array(
     array(
       'type' => 'welcome',
       'icon' => 'hei hei-smile-o',
     ),
     array(
       'type' => 'social',
       'icon' => 'hei hei-comments-o',
     ),
     array(
       'type' => 'twitter',
       'icon' => 'hei hei-twitter',
     ),
   ),
   ...
   'wall_composer' => array(
    array(
     ...
     array(
      ...
      'plugin' => 'Wall_Plugin_Composer_Heemoticon',
      'auth' => array('heemoticon', 'view'),
      'module' => 'heemoticon',
...
/*    array(
  ...
  'wall_service' => array(
    ...
    array(
      'plugin' => 'Wall_Plugin_Service_Soundcloud',
      'type' => 'soundcloud'
    )
  ),
