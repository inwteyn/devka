 ...
 * @version    $Id: Soundcloud.php 13.01.15 9:52 Bolot $
 * @author     Bolot
 */
...
class Wall_Plugin_Service_Soundcloud extends Wall_Plugin_Service_Abstract
{
  /**
   * Custom cURL option
   *
   ...
   * @access public
   */
  function __construct($clientId = 'b402ad76553b57a62647f38c87022215', $clientSecret = '880c815d75d9b9d5c747c656fec18fab', $redirectUri = null, $development = false)
  {
    if (empty($clientId)) {
