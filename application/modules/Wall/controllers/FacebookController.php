...
class Wall_FacebookController extends Core_Controller_Action_Standard
{
  ...
  public function indexAction()
  {
    ...
    if (empty($code)){
      ...
      $url = "http://www.facebook.com/dialog/oauth?client_id=". $config['client_id'] . "&redirect_uri=" . $redirect_uri . "&state=" . $session->state . "&scope=publish_actions,manage_pages&auth_type=reauthenticate";
      header("Location: $url");
      exit(1);
