  ...
  public function indexAction()
  {
    ...
    try {
      ...
      if ($return_params['oauth_token']) {
        ...
        $oauth->redirect(array('client_id' => $setting->getSetting('wall.service.linkedin.consumerkey'),'redirect_uri' => $redirect_uri,'state'=>'DCEeFWf45A53sdfKef424','response_type'=>'code'));
