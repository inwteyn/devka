...
class Wall_AdminSettingController extends Core_Controller_Action_Admin
{
    public function indexAction()
    {
        ...
        $list = new Wall_Form_Admin_Changefeed();
        $form->addSubForm($list, 'change-feed');
    ...
    {
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('wall_admin_main', array(), 'wall_admin_social_setting');
    ...
    {
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('wall_admin_main', array(), 'wall_admin_feed_setting');
