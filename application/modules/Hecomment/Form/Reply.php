 ...
 * @author     Bolot
 */
class Hecomment_Form_Reply extends Engine_Form
{
...
COVER;
        ...
        $this->addElement('Textarea', 'body', array(
            ...
            'placeholder' => $view->translate("Reply comment"),
            'order' => 1
        ));
        ...
        $this->addElement('Hidden', 'comment_identity', array(
            'order' => 993,
            'validators' => array(
                'Int'
            ),
        ));
        $this->addElement('Hidden', 'comment_type', array(
            'order' => 994,
            'validators' => array(
                'Int'
            ),
        ...
        $this->addElement('Hidden', 'comment_owner', array(
            'order' => 995,
            'validators' => array(
                'Int'
            ),
    ...
    public function setCommentIdentity($action_id)
    {
        $this
