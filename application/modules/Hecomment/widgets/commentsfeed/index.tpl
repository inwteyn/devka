    ...
    <div class='comments_options'>
        ...
        <?php if (isset($this->form)): ?>
            - <a href='javascript:void(0);'
                 onclick="$('hecomment-form-<?php echo $this->subject->getIdentity(); ?>').style.display = '';$('hecomment-form-<?php echo $this->subject->getIdentity(); ?>').body.focus();"><?php echo $this->translate('Post Comment') ?></a>
        <?php endif; ?>
        ...
        <li id="comment-<?php echo $comment->comment_id ?>">
            ...
            <span class="comments_body">
              ...
              ?>
                ...
                <div class="comments_date">
                    ...
                    <a href="javascript:void(0)" onclick="show_comment_form_reply(<?php echo $comment->comment_id ?>)">
            ...
            <div class='comments_reply' style=" margin-left: 50px;">
                ...
                <?php  if (isset($this->reply_form)) {
                    ...
                    echo $this->reply_form->setCommentIdentity($comment->comment_id)->setAttribs(array('id' => 'comment-form-reply-' . $comment->comment_id, 'class' => 'hecomment-form-class', 'style' => 'display:none;'))->render();
                }

                ?>
                <div id="preview_comment_reply_attach_wall">
                    <div class="comment_attach_loading_wall"
                         id="comment_attach_loading_wall<?php echo $comment->comment_id; ?>"></div>
                    <div class="comment_attach_preview_image_wall"
                         id="comment_attach_preview_image_wall<?php echo $comment->comment_id; ?>"></div>
                </div>
...
<?php if (isset($this->form)) echo $this->form->setAttribs(array('id' => 'hecomment-form-' . $this->subject->getIdentity(), 'style' => 'display:none;'))->render() ?>

    <div id="preview_comment_reply_attach_wall">
        <div class="comment_attach_loading_wall"
             id="comment_attach_loading_wall<?php echo $this->subject->getIdentity(); ?>"></div>
        <div class="comment_attach_preview_image_wall"
             id="comment_attach_preview_image_wall<?php echo $this->subject->getIdentity(); ?>"></div>
    </div>
<?php if (!$this->page): ?>
    </div>
<?php endif; ?>