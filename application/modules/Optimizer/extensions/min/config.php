...
// TODO here we going use file cache for support of a CDN server
$current_dir = realpath(dirname(__FILE__));
$current_dir = str_replace('application/modules/Optimizer/extensions/min', 'temporary/scaffold', $current_dir);
$min_cachePath = $current_dir;
