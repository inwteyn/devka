...
?>
  <script type="text/javascript">
    ...
    function click_hashtags_closes(){
      ...
      var wall_feed_id = $$('.wallFeed').get('id');
      var feed = Wall.feeds.items[wall_feed_id];
      feed.loadFeed('','',function(){feed.maxid=0;$('activity-feed').getElement('.pagination').getChildren('a').fireEvent('click')},'',$('activity-feed'));
  ...
  <div class="hashtag_composer_cont display_none">
    <?php if($this->update>0){

    }else{
   ?>
        <div class="hashtag-tag-contaner">
        <nav class="he-navbar he-navbar-default" role="navigation">
            <div class="he-container-fluid">
                <div class="he-navbar-header">
                    <button type="button" class="he-navbar-toggle he-collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-3">
                        <span class="he-sr-only">Toggle navigation</span>
                        <span class="he-icon-bar"></span>
                        <span class="he-icon-bar"></span>
                        <span class="he-icon-bar"></span>
                    </button>
                    <a class="he-navbar-brand wp_init" href="#"><?php echo $this->translate('HASHTAG_TITLE');?></a>
                </div>
                <div class="he-collapse he-navbar-collapse">
                    <div class="he-btn-group">
                        <a type="button" href="javascript:void(0)" class="he-btn he-btn-default he-navbar-btn wp_init" title="#<?php echo  $this->name?>"> #<?php echo  $this->name?></a>
                        <a type="button" onclick="click_hashtags_closes()" class="he-btn he-btn-default he-navbar-btn wp_init"><span class="he-glyphicon he-glyphicon-remove"></span></a>
                    </div>
                </div>
            </div>
        </nav>
