...
?>
    ...
    ?>
      <div style="margin: 5px; padding: 5px;">
        <?php echo '<a href="javascript:void(0)" class="trands_hashtag" onClick="click_hashtags(\''.$url.'\',\''.$tag->hashtag. '\', \''.$this->translate("WALL_RECENT").'\',\'widget\',\'\',false);" title="'.$this->translate('TITLE_LINK_HASHTAG').'">#'.$tag->hashtag.'</a>'; ?>
      </div><div style="clear: both"></div>
    <?php
    }
