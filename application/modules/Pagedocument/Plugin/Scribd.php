...
class Pagedocument_Plugin_Scribd
{
  public $api_key;
  public $secret;
  private $url;
...
//    $this->url = "http://api.scribd.com/api?api_key=" . $api_key;
  ...
  public function setParams($api_key, $secret){
    $this->api_key = $api_key;
    $this->secret = $secret;
    $this->url = "http://api.scribd.com/api?api_key=" . $api_key;
   }
   ...
   * @return array containing doc_id, access_key, and secret_password if nessesary.
   */
  public function uploadFromUrl($url, $doc_type = null, $access = 'public', $download_allow = 'download-pdf', $secure_allow = 1){
    $method = "docs.uploadFromUrl";
    $params['url'] = $url;
    $params['doc_type'] = $doc_type;
    $params['access'] = $access;
    $params['download_and_drm'] = $download_allow;
    $params['secure'] = $secure_allow;
  ...
  public function getList(){
    ...
    $result = $this->postRequest($method, array());
   ...
   */
  public function getConversionStatus($doc_id, $my_user_id = null){
  ...
  */
  public function getSettings($doc_id, $my_user_id = null){
  ...
  public function getDonloadLink($doc_id, $doc_type, $my_user_id = null){
   ...
   * @return 1 on success;
   */
  public function delete($doc_id, $my_user_id = null){
    $method = "docs.delete";
    $params['doc_id'] = $doc_id;
